    ...
    <div className="container">
      ...
      <section id="column-right" className="column">
        <div id="menu">
          ...
          <nav id="rsnav">
          <a href="/CV.pdf" target="blank" rel="noopener noreferrer" data-info="CV" className="info-bulle">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"/></svg>
            </div>
          </a>
          <a href="https://www.linkedin.com/in/lucas-hatet/" target="blank" data-info="LinkedIn" className="info-bulle">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M100.3 448H7.4V148.9h92.9zM53.8 108.1C24.1 108.1 0 83.5 0 53.8a53.8 53.8 0 0 1 107.6 0c0 29.7-24.1 54.3-53.8 54.3zM447.9 448h-92.7V302.4c0-34.7-.7-79.2-48.3-79.2-48.3 0-55.7 37.7-55.7 76.7V448h-92.8V148.9h89.1v40.8h1.3c12.4-23.5 42.7-48.3 87.9-48.3 94 0 111.3 61.9 111.3 142.3V448z"/></svg>
            </div>
          </a>
          <a href="https://www.github.com/lucas-hatet/" target="blank" data-info="GitHub" className="info-bulle">
            <div>
          ...
          <Link to="/contacts" data-info="Contacts" className="info-bulle">
            <div>
